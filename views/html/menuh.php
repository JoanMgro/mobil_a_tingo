<ul class="menu-list">
        ...
        <li class="menu-list__menu-item menu-list__menu-item_hover">
          <a class="menu-list__menu-link link-text_nav" href="../../index.php?pg=1001">home</a>
        </li>
        <li class="menu-list__menu-item menu-list__menu-item_hover">
          <a class="menu-list__menu-link link-text_nav" href="../../index.php?pg=1002">Faq</a>
          </li>
        <li class="menu-list__menu-item menu-list__menu-item_hover">
          <a class="menu-list__menu-link link-text_nav" href="../../index.php?pg=1003">buuu</a>
          </li>
        <li class="menu-list__menu-item menu-list__menu-item_hover">
        ...
        <li class="menu-list__menu-item menu-list__menu-item_log-in">
          <a class="menu-list__menu-link_log-in log-in link-text_nav" href="../../controllers/logout.php">
            <span class="log-in__span">Salir</span>            
