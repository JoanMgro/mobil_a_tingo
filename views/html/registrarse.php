<section class="main__section section section_registrarse">
  ...
  <form id="registrase" action="" method="" class="form form_registrarse">
    ...
    <input id="email" class="form__input_registro_login-info input input_registro" type="email" name="email" autocomplete="off">
    <!-- campo password -->
    <label class="form__label_login" for="pass">Password:</label>
    <input id="pass" class="form__input_registro_login-info input input_registro" type="password" name="pass" autocomplete="off">
    ...
    <input id="nombre" class="form__input_registro_login-info input input_registro" type="text" name="nombre" autocomplete="off">
    <!-- campo nit -->
    <label class="form__label_registro_login-info" for="nit">Nit:</label>
    <input id="nit" class="form__input_registro_login-info input input_registro" type="text" name="nit" autocomplete="off">
    <!-- campo logo -->
    ...
    <input id="latitud" class="form__input_registro input input_registro" type="text" name="latitud" autocomplete="off">
    <label class="form__label" for="longitud">Coord Longitud:</label>
    <input id="longitud" class="form__input_registro input input_registro" type="text" name="longitud" autocomplete="off">
    <!-- Campo pais -->
    <label class="form__label label " for="pais">Pais:</label>
    <input id="pais" class="form__input_registro input input_registro" type="text" name="pais" autocomplete="off">
    <!-- Campo departamento -->
    <label class="form__label label " for="departamento">Departamento:</label>
    <input id="departamento" class="form__input_registro input input_registro" type="text" name="departamento" autocomplete="off">
    <!-- Campo ciudad -->
    <label class="form__label label " for="ciudad">Ciudad:</label>
    <input id="ciudad" class="form__input_registro input input_registro" type="text" name="ciudad" autocomplete="off">
    <!-- Campo barrio -->
    <label class="form__label label " for="barrio">Barrio:</label>
    <input id="barrio" class="form__input_registro input input_registro" type="text" name="barrio" autocomplete="off">
    <!-- Campo direccion -->
    <label class="form__label_registro-direccion" for="direccion">Direccion:</label>
    <input id="direccion" class="form__input_registro-direccion input input_registro" type="text" name="direccion" autocomplete="off">
    ...
    <div id="telf-container" class="form__field-container_tel">
      <div id="t-0"  class="field-container field-container_tel">
        ...
        <input id="t-0-2" class="input input_registro field-container__input_tel" type="number" name="u-tel-fijo" autocomplete="off">
